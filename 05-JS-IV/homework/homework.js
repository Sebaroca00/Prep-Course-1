...
function crearGato (nombre, edad) {
  // Crear un nuevo objeto con la propiedad "nombre" y 
  //el valor definido como el argumento "nombre".
...
function invocarMetodo (objeto, metodo) {
  // "metodo" es una cadena/string que contiene el nombre de un método 
...
// var usuarios [ objeto1, objeto2, objeto3 ]
...
function agregarMetodoCalculoDescuento (producto) {
  ...
  // El método resta el descuento del precio 
